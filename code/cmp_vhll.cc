...
/* --------------------------------------------------------------- */
  ...
  //std::vector<time_stages> durations_s; durations_s.reserve(int(std::ceil(c.Tf/iter.dt))+1);


  auto save_data = [&] ( std::string && suffix ) {
/////// begin save_data routine ///////////////////////////////////////
    ...
    auto writer_times = [&,count=0] (auto const & t ) mutable {
      std::stringstream ss;
      ss<<times[count++]<<" "<<t.step.count()<<" "<<t.stage_1.count()<<" "<<t.stage_2.count()<<" "<<t.stage_3.count()<<" "<<t.stage_4.count();
      return ss.str();
    };
...
/////////////////////////////////////////////////////////////////////
    ...
    //durations_s.push_back({ end_s4-start , end_s1-start , end_s2-end_s1 , end_s3-end_s2 , end_s4-end_s3 });
