...
/* ------------------------------------------------------------------------- */
  ...
  const double alpha1 = 1./(4. - std::cbrt(4.));
  const double alpha2 = alpha1;
  const double alpha3 = 1./(1. - (std::cbrt(4.))*(std::cbrt(4.)) );
  ...
  while ( current_t<c.Tf ) {
    ...
    // Strang alpha 1
    Lie.H_E (alpha1*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_B (alpha1*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_jc(alpha1*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_f (alpha1*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_jc(alpha1*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_B (alpha1*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_E (alpha1*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);

    // Strang alpha 2
    Lie.H_E (alpha2*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_B (alpha2*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_jc(alpha2*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_f (alpha2*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_jc(alpha2*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_B (alpha2*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_E (alpha2*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);

    // Strang alpha 3
    Lie.H_E (alpha3*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_B (alpha3*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_jc(alpha3*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_f (alpha3*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_jc(alpha3*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_B (alpha3*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
    Lie.H_E (alpha3*0.5*dt,jcx,jcy,Ex,Ey,Bx,By,hf);
